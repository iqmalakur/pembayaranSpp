...
<form action="/jurusan/save" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nama_jurusan" class="form-control text-capitalize <?= isset($errors['nama_jurusan']) ? 'is-invalid' : ''; ?>" id="nama_jurusan" value="<?= old('nama_jurusan') ? old('nama_jurusan') : ''; ?>">
